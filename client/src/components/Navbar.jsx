...
const Navbar = () => {
  ...
  return (
    <div className="h-16 dark:bg-[#020817] bg-white border-b dark:border-b-gray-800 border-b-gray-200 
    ...
    <Sheet>
      ...
      <SheetContent className="flex flex-col">
        ...
        <nav className="flex flex-col space-y-4">
          ...
          <SheetClose asChild>
            <p className="cursor-pointer text-red-500" onClick={logoutHandler}>Log out</p>
          </SheetClose>
        </nav>
        {user?.role === "instructor" && (
          <SheetFooter>
